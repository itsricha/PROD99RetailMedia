...
public class DoctorSessions extends Fragment {
    ...
    String doctor1, specialization1,specId, hospital1, doctorId, hospitalId ,frmdate;
    String todate;
    ImageButton back;
    private String st;
            ...
            public String doInBackground(String... params) {
              ...
              */
                ...
                Request request = new Request.Builder()
                        .url("https://ideabiz.lk/apicall/docs/V2.0/doctor-sessions?hospitals=" + hospitalId + "&doctor=" + doctorId + "&from=" + frmdate+ "&to=" + todate + "&specialization=" + specId)
                ...
                try {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        for (int i = 0; i < jsonSessionArray.length(); i++) {
                            ...
                            Log.d(":::::::::", id);
                            String status = jsonObject.getString("canBook");
                            String time = jsonObject.getString("sessionAt");
                            String nextpatient = jsonObject.getString("nextPatient");
                            SessionPojo sessionPojo = new SessionPojo(status, time, nextpatient, id);
