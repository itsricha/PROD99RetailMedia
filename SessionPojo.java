...
public class SessionPojo {
    ...
    public SessionPojo(String status, String time, String nextpatient, String id) {
        this.status = status;
        this.sessionAt=time;
    ...
    public String getScanBook() {
        return ScanBook;
    }

    public void setScanBook(String scanBook) {
        ScanBook = scanBook;
    }
    ...
    public SessionPojo(String id, String sessionAt, String activePatients, String status, String scanBook, String publicNote, String nextPatient, String maxPatientCount, String totalLocalCharge, String totalOverseasCharge) {
        this.id = id;
        this.sessionAt = sessionAt;
        this.activePatients = activePatients;
        this.status = status;
