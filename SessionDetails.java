...
public class SessionDetails extends Fragment {
    ...
    String doctorcharges,hospitalcharge,bookingchargr,doctorvat;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tvnamehospital = (TextView) view.findViewById(R.id.hospital);
            ...
            public String doInBackground(String... params) {
                try {
                    ...
                    RequestBody body = new FormBody.Builder().add("title",patienttitle).
                            add("name", patientname).add("phone", patientphone).add("nic", patientnic).
                            add("session", id).add("bookingType", "1").
              ...
              */
                    ...
                    try {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            Log.d("$$$$$$",doctorcharges+ " "+bookingchargr + hospitalcharge + agent);
    ...
    public void DoctorlistProcess(final String userTyped) {
              ...
              */
                ...
                try {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        hospital = jsonObjects.getString("hospitals");
        ...
        SimpleDateFormat formatter1 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");*/
                ...
                tvdoctorName.setText(title + doctorName);
